...
def start_training(char_name, char_class):
    if char_class == 'warrior':
        return print(f'{char_name}, ты Воитель — отличный боец ближнего боя.')
    if char_class == 'mage':
        return print(f'{char_name}, ты Маг — превосходный укротитель стихий.')
    if char_class == 'healer':
        return print(f'{char_name}, ты Лекарь — чародей,'
